...
namespace Financial.Tracker
{
    ...
    internal class DBConnection
    {
        ...
        /// </summary>
        static readonly SqlConnection sqlConnection = new SqlConnection(@"Data Source = 192.168.31.153; Initial Catalog = Tracker_DB; Persist Security Info=True;User ID = admin; Password=Sa1234@@;Encrypt=False;TrustServerCertificate=True");
